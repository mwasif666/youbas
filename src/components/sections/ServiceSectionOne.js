    ...
    const services = [
        {
            ...
            description: "WordPress, WooCommerce, Shopify stores & custom web-based portals under development.",
            icon: serviceIcon1_2,
            link: "/service-details",
        },
        {
            id: 2,
            title: "Product Sourcing & DDP Logistics",
            description: "Source any product directly from factories and deliver DDP to your door in USA, UK & Australia.",
            icon: serviceIcon1_1,
            link: "/service-details",
        },
        {
            ...
            description: "End-to-end management of your stores — listings, orders, account health, scaling & optimization.",
            icon: serviceIcon1_3,
            link: "/service-details",
        },
        {
            ...
            description: "From product idea to branded packaging, trademarks, and brand registry — we handle it all.",
            icon: serviceIcon1_4,
            link: "/service-details",
        },
        {
            ...
            description: "Social media management, TikTok content, ads, influencer strategy & digital product branding.",
            icon: serviceIcon1_5,
            link: "/service-details",
        },
    ];

    ...
    <section className="about1 section-padding fix">
      <div className="container">
        <div className="row g-3 align-items-center">
          <div className="col-sm-6 col-lg-6 align-items-center">
            <div className="about1-thumb position-relative">
              {/* <div className="about1-thumb__two">
                <img src={aboutThumb2.src} alt="thumb" />
              </div> */}

              <img
                src="https://impact.com/wp-content/uploads/2025/11/earn-on-referral.webp"
                alt="thumb"
              />
              <div
          ...
          <div className="offset-lg-1 col-xl-5 col-lg-5 ">
            <div className="about1-content">
              <div className="section-top">
                ...
                <h2 className="section-top__title pb-20">
                  YouBas Ecom Services
                </h2>
                <p className="section-top__desc">
                  YouBas Ecom Services is a global e-commerce solutions partner
                  operating since 1998. We help business owners, brands, and
                  wholesalers build, manage, scale, and automate profitable
                  operations across Amazon, eBay, Walmart, and other
                  international marketplaces—powered by factory-direct sourcing
                  and DDP logistics.
                </p>
              </div>
              <div className="about1-content-checklist">
                <ul>
                  <li className="about1-content-checklist-item">
                    ...
                    <span className="about1-content-checklist-item__text">
                  ...
                  <li className="about1-content-checklist-item">
                    ...
                    <span className="about1-content-checklist-item__text">
                      Direct factory collaboration (OEM / ODM)
                    </span>
                  </li>
                  <li className="about1-content-checklist-item">
                    <span>
                    ...
                    <span className="about1-content-checklist-item__text">
                      Factory-level pricing — no intermediaries
                    </span>
                  </li>
                </ul>
              </div>
              <div className="btn-wrapper">
                <Link className="theme-btn style1" href="/about">
                  Learn More
                </Link>
              </div>
            </div>

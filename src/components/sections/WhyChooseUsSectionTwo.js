...
import wcuShape1_4 from "@/assets/images/shape/wcuShape1_4.png";
import wcuShape1_5 from "@/assets/images/shape/wcuShape1_5.png";

export default function WhyChooseUsSectionTwo() {
    return (
        <section className="wcu1 section-padding fix">
                    ...
                    <div className="col-lg-6 col-xl-5">
                        <div className="wcu1-content">
                            <div className="section-top">
                                ...
                                <h2 className="section-top__title pb-20">Great solutions for your business.</h2>
                                <p className="section-top__desc">There are many variations of passages of Lorem
                                    available,
                            ...
                            <div className="progress-wrap pt-45">
                                <div className="progress-meta">
                                    <div className="title2">Web Development</div>
                                    <div className="percentage2">90%</div>
                                </div>
                            ...
                            <div className="progress-wrap">
                                <div className="progress-meta mxw-424">
                                    <div className="title2">UI/UX Design</div>
                                    <div className="percentage2">80%</div>
                                </div>
                                <div className="progress-container">
                                    <div className="progress-bar"
                                         style={{ width: '80%'}}>
                            ...
                            <div className="progress-wrap">
                                <div className="progress-meta mxw-375">
                                    <div className="title2">Digital Marketing</div>
                                    <div className="percentage2">70%</div>
                                </div>
                                <div className="progress-container">
                                    <div className="progress-bar"
                                         style={{width: '70%'}}>
                    ...
                    <div className="offset-xl-1 col-xl-3 col-lg-3 col-sm-6">
                        <div className="wcu1-thumb">
                            ...
                            <div className="wcu1-thumb__shape4">
                                <img src={wcuShape1_4.src} alt="shape"/>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-3 col-lg-3 col-sm-6">
                        <div className="wcu1-thumb">
                            ...
                            <div className="wcu1-thumb__shape1">
                                <img src={wcuShape1_5.src} alt="shape"/>
                            </div>
